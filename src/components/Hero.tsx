...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden print:hidden">
      <div
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight animate-fade-down opacity-0 text-balance" style={{ animationDelay: '300ms', animationFillMode: 'forwards' }}>
          Building distributed systems<br className="hidden sm:block" /> with precision & purpose
        </h1>
        ...
        <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto animate-fade-down opacity-0 text-balance" style={{ animationDelay: '500ms', animationFillMode: 'forwards' }}>
          I'm Gaurav Agarwal, a passionate developer focused on creating intuitive and
          impactful distributed systems that solve real-world problems with elegant solutions.
        </p>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-up opacity-0" style={{ animationDelay: '700ms', animationFillMode: 'forwards' }}>
          <Button size="lg" className="min-w-[160px]" onClick={() => {window.location.href = "mailto:algogrit@gmail.com?subject=Let's work together"}}>
        ...
        <div className="mt-12 flex justify-center space-x-6 animate-fade-up opacity-0" style={{ animationDelay: '900ms', animationFillMode: 'forwards' }}>
          <a href="https://github.com/algogrit" className="text-muted-foreground hover:text-foreground transition-colors">
            <Github className="h-6 w-6" />
            <span className="sr-only">GitHub</span>
          </a>
          <a href="https://linkedin.com/in/algogrit" className="text-muted-foreground hover:text-foreground transition-colors">
